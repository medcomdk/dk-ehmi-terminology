...
Alias: $EhmiDeliveryStatusSubTypes = http://hl7.org/fhir/ValueSet/audit-event-sub-type
...
Alias: $EhmiDeliveryStatusSourceTypeValueset = http://medcomehmi.dk/ig/dk-medcom-ehmi-terminology/ValueSet/ehmi-delivery-status-source-type-valueset
...
Alias: $EhmiDeliveryStatusParticipationRoleTypeValueset = http://medcomehmi.dk/ig/dk-medcom-ehmi-terminology/ValueSet/ehmi-delivery-status-participationroletype-valueset
...
Alias: $EhmiDeliveryStatusAgentWhoIdentifierTypesValueset = http://medcomehmi.dk/ig/dk-medcom-ehmi-terminology/ValueSet/ehmi-delivery-status-agent-who-identifier-types-valueset
...
Alias: $EhmiDeliveryStatusEntityTypeValueset = http://medcomehmi.dk/ig/dk-medcom-ehmi-terminology/ValueSet/ehmi-delivery-status-entity-type-valueset
