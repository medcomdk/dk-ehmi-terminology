...
* ^experimental = false
* ^caseSensitive = true
* #urn:dk:healthcare:medcom:fhir:homecareobservation "HomeCareObservation"
* #urn:dk:healthcare:medcom:fhir:acknowledgement "Acknowledgement"
* #urn:dk:healthcare:ehmi:envelope:xml:sbdh "ehmiSBDH"
* #urn:dk:healthcare:ehmi:envelope:xml:sbdhacknowledgement "ehmiSBDH Ack"
