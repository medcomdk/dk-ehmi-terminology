...
* #urn:dk:healthcare:medcom:messaging:fhir:structuredefinition:medcom-hospitalnotification-message:1.0 "HospitalNotification 1.0"
* #urn:dk:healthcare:medcom:messaging:fhir:structuredefinition:medcom-hospitalnotification-message:2.0 "HospitalNotification 2.0"
* #urn:dk:healthcare:medcom:messaging:fhir:structuredefinition:medcom-hospitalnotification-message:3.0 "HospitalNotification 3.0"
* #urn:dk:healthcare:medcom:messaging:fhir:structuredefinition:medcom-carecommunication-message:1.0 "CareCommunication 1.0"
* #urn:dk:healthcare:medcom:messaging:fhir:structuredefinition:medcom-carecommunication-message:2.0 "CareCommunication 2.0"
* #urn:dk:healthcare:medcom:messaging:fhir:structuredefinition:medcom-carecommunication-message:2.1 "CareCommunication 2.1"
* #urn:dk:healthcare:medcom:messaging:fhir:structuredefinition:medcom-carecommunication-message:3.0 "CareCommunication 3.0"
* #urn:dk:healthcare:medcom:messaging:fhir:structuredefinition:medcom-homecareobservation-message:1.0 "HomeCareObservation 1.0"
* #urn:dk:healthcare:medcom:messaging:fhir:structuredefinition:medcom-homecareobservation-message:1.1 "HomeCareObservation 1.1"
* #urn:dk:healthcare:medcom:messaging:fhir:structuredefinition:medcom-messaging-acknowledgement:1.0 "Acknowledgement 1.0"
* #urn:dk:healthcare:medcom:messaging:fhir:structuredefinition:medcom-messaging-acknowledgement:2.0 "Acknowledgement 2.0"
